...
from ...i18n import _
from ...util import make_dir, InvalidPassword, UserCancelled
from ...gui.qt.util import (read_QIcon, EnterButton, WWLabel, icon_path,
...
class Plugin(RevealerPlugin):
    ...
    def __init__(self, parent, config, name):
        ...
        self.base_dir = os.path.join(config.electrumfairchains_path(), 'revealer')
