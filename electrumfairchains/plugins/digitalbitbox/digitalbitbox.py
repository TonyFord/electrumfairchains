...
from ...crypto import sha256d, EncodeAES_base64, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from ...bitcoin import (TYPE_ADDRESS, push_script, var_int, public_key_to_p2pkh,
                              is_address)
...
from ...util import print_error, to_string, UserCancelled, UserFacingException
from ...base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
...
class DigitalBitbox_Client():
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("ElectrumFairChains-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
