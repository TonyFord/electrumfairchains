...
from electrumfairchains import WalletStorage, Wallet
from ..util import format_satoshis, set_verbosity
from ..bitcoin import is_address, COIN, TYPE_ADDRESS
from ..transaction import TxOutput
from ..network import TxBroadcastError, BestEffortRequestFailed
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print("Wallet not found. try 'efc create'")
            exit()
    ...
    def network_dialog(self):
        print("use 'efc setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'efc setconfig' to change your settings")
        return True
